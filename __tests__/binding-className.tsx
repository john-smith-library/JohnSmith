...
const ApplicationView = (viewModel: ViewModel) => (
  <div $className={viewModel.status} />
);

const ApplicationViewWithCustomClasses = (viewModel: ViewModel) => (
  <div class="app" $className={viewModel.status} />
);
...
it(
  'should respect existing classes',
  setupAppContainerAndRender(
    ApplicationViewWithCustomClasses,
    new ViewModel('active'),
    (container, viewModel) => {
