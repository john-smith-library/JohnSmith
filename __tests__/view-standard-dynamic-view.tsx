...
describe('polymorphic view model rendering', () => {
  it(
    'should render circle',
    setupAppContainerAndRender(
      ApplicationView,
      new ViewModel(new Circle()),
      container => {
        expect(container.innerHTML).toBe(
          '<section><span>Circle</span></section>'
        );
      }
    )
  );
  it(
    'should render rectangle',
    setupAppContainerAndRender(
      ApplicationView,
      new ViewModel(new Rectangle()),
      container => {
        expect(container.innerHTML).toBe(
          '<section><span>Rectangle</span></section>'
        );
      }
    )
  );
