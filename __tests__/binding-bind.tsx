...
import { DisposableStub, setupAppContainerAndRender } from './_helpers';
import '../src/view/jsx';
...
it(
  'should allow DOM modifications in callback',
  setupAppContainerAndRender(
    ApplicationView,
    new ViewModel(function (el: DomElement) {
